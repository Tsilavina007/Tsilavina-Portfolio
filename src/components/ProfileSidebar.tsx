	...
	return (
		<aside className="w-full md:w-[396px] px-4 py-6 h-fit md:py-8 z-10">
			...
			<div className="mt-4 slide-up delay-100">
				...
				<Button onClick={handleClick} variant="outline" className="w-full bg-github-medium border border-github-light text-github-text hover:bg-github-light hover:border-gray-500 hover:text-white mb-4 py-1 h-auto transition-all-200">
					Contact me
				</Button>
